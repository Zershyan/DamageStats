...
public record StorageOverview(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, StorageOverview> STREAM_CODEC =
            StreamCodec.of(StorageOverview::encode, StorageOverview::decode);

    private static void encode(RegistryFriendlyByteBuf buf, StorageOverview overview) {
    ...
    private static StorageOverview decode(RegistryFriendlyByteBuf buf) {
