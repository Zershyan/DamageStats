...
public final class DSConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue TrackingEnabled = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue SessionTimeoutTicks = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue DpsWindowTicks = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue InstanceDirectoryRetentionHours = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue InstanceDirectoryLimit = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue KeepFinishedSessions = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue AutoSave = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue AutoSaveIntervalTicks = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue PublicStats = BUILDER
